<?php
$cinematico_theme_svg_icons = array(
	'fort-awesome'         => array(
...
$cinematico_theme_divider_style = array(
...
$cinematico_theme_action_button           = 'Start Your Journey';
$cinematico_theme_action_button_secondary =  'Contact us';

$cinematico_theme_click_pen_to_edit_title = 'Create Your Own Opportunities';
$cinematico_lorem_ipsum                   = 'Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae. In his nemore temporibus consequuntur, vim ad prima vivendum consetetur.';


return array(
	'default_icon'                      => $cinematico_theme_svg_icons['fort-awesome'],
	'icons'                             => $cinematico_theme_svg_icons,
	'divider_style'                     => $cinematico_theme_divider_style,
	'lorem_ipsum'                       => $cinematico_lorem_ipsum,
	'edit_this_text_in_customizer'      => $cinematico_theme_click_pen_to_edit_title,
	'gradients'                         => $cinematico_gradients,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $cinematico_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $cinematico_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $cinematico_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'left',
						...
						'background' => array(
							...
							'image'     => array(
								array(
									'source'     => array(
										'url'      => get_template_directory_uri() . '/resources/images/background-image.jpg',
										'gradient' => $cinematico_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $cinematico_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $cinematico_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $cinematico_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $cinematico_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $cinematico_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $cinematico_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $cinematico_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $cinematico_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $cinematico_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $cinematico_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $cinematico_theme_svg_icons['phone-square'],
