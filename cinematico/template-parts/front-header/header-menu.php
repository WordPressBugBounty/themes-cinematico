...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer cinematico-front-header__k__c6BbujDIAOY-outer cinematico-local-150-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row cinematico-front-header__k__0xSC3AT64-container cinematico-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  cinematico-front-header__k__0xSC3AT64-image cinematico-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   cinematico-front-header__k__0xSC3AT64-alternateImage cinematico-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  cinematico-front-header__k__0xSC3AT64-text cinematico-local--text',
)); ?>
										</div>
									</div>
								</div>
