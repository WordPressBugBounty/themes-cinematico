...
use CinematicoTheme\SiteLeadsThemeKit\SiteLeads;
...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'                          => cinematico_theme()->getPluginsManager()->getPluginState( cinematico_get_builder_plugin_slug() ),
			'install_url'                     => cinematico_theme()->getPluginsManager()->getInstallLink( cinematico_get_builder_plugin_slug() ),
			'activate_url'                    => cinematico_theme()->getPluginsManager()->getActivationLink( cinematico_get_builder_plugin_slug() ),
			'slug'                            => cinematico_get_builder_plugin_slug(),
...
<div class="cinematico-admin-big-notice--container">
	<div class="logo-holder">
        <h2><?php echo sprintf(__("Choose one of the %s predefined designs to start with:", 'cinematico'), ucfirst(get_stylesheet())); ?></h2>
	</div>
	<div class="content-holder">
		<ul class="predefined-front-pages">
            ...
            $front_page_designs =  array(
                array(
                    'name'    => __( 'Modern', 'cinematico' ),
                    'index'   => 1,
                    'preview' => 'front-page-1.jpg',
                ),

                array(
                    'name'    => __( 'Fullscreen', 'cinematico' ),
                    'index'   => 2,
                    'preview' => 'front-page-2.jpg',
                ),

                array(
                    'name'    => __( 'Classic', 'cinematico' ),
                    'index'   => 3,
            ...
            foreach ( $front_page_designs as $cinematico_design_index => $design ) : ?>
				<?php
					$cinematico_design_selected = $cinematico_design_index === 0 ? 'selected' : '';
				...
				<li data-index="<?php echo esc_attr( $design['index'] ); ?>"
					class="<?php echo $cinematico_design_selected; ?>">
                    ...
                    <div class="predefined-front-page-card">
						...
						<div class="front-page-design-wrapper">
							<div class="design-preview-image"
								 style="background-image: url(<?php echo esc_attr( cinematico_theme()->getAssetsManager()->getBaseURL() . "/images/{$preview_image_name}" ); ?>)"
							></div>
						</div>
